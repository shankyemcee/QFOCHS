...
with open("pew/bart_data/targetAnswers.txt", 'r',encoding='utf8') as actualfile:
            actual = actualfile.readlines()
            

with open("pew/bart_data/generated_predictions.txt", 'r',encoding='utf8') as generatedfile:
...
with open('pew/bart_data/targetAnswers.json','w') as f:
    json.dump(output_list_actual,f)


with open('pew/bart_data/generatedAnswers.json','w') as f:
