...
predict_path = "output/final_dataset/qs/predictions.json"

target_gold_path = "output/final_dataset/qs/targetAnswers.txt"
target_predict_path = "output/final_dataset/qs/generatedAnswers.txt"
