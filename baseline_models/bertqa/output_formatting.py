...
predict_path = "output/final_dataset/qtc(tb)a/predictions.json"

target_gold_path = "output/final_dataset/qtc(tb)a/targetAnswers.txt"
target_predict_path = "output/final_dataset/qtc(tb)a/generatedAnswers.txt"
